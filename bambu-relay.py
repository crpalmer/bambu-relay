...
error_strings = [
    ...
    ErrorString([ "0700-8011" ], "AMS filament ran out.  Please insert new filament into the same AMS slot."),
    ...
    ErrorString([ "05FF-8053" ], "The right nozzle is not matched with slicing file."),
